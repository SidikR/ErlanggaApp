...
@section('content')
    ...
    <main class="mx-6 mt-3 rounded-lg border-gray-200 bg-slate-50 p-6 shadow-lg dark:border-gray-700">
        ...
        <h1 class="mb-4 text-center text-4xl font-bold text-gray-900">Add Galery</h1>
        ...
        <form action={{ route('galery.store') }} method="post" enctype="multipart/form-data">
                ...
                <div class="input w-full">
                    <div class="mb-4">
                        <label for="galery_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Galery
                            Name</label>
                        <input type="text" id="galery_name" name="galery_name" value="{{ old('galery_name') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description_galery" rows="10" name="description_galery"
                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                            placeholder="Write galery description here..." required>{{ old('description_galery') }}</textarea>
            ...
            @include('admin.pages.galery.partials.modal-create')
        </form>
    </main>
    <script>
