...
@section('content')
    ...
    <main class="mx-6 mt-3 rounded-lg border-gray-200 bg-slate-50 p-6 shadow-lg dark:border-gray-700">
        ...
        <h1 class="mb-4 text-center text-4xl font-bold text-gray-900">List Products</h1>

        <a href={{ route('products.create') }}>
            <x-addButton>Add Product</x-addButton>
        </a>

        <table id="tb_products" class="dislay" style="width:100%">
            <thead>
                <tr>
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td class="flex items-center px-6 py-4">
                            ...
                            {{-- Read Button --}}
                            <a href={{ route('products.show', ['product' => $product->uuid]) }}><button type="button"
                            ...
                            {{-- Delete Buton --}}
                            <form action="{{ route('products.destroy', ['product' => $product->uuid]) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <div id="popup-modal{{ $product->name }}" tabindex="-1"
                                        ...
                                        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 text-center md:p-5">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                    ...
                                                    this product?</h3>
                                                <button data-modal-hide="popup-modal{{ $product->name }}" type="submit"
                                                ...
                                                <button data-modal-hide="popup-modal{{ $product->name }}" type="button"
                                ...
                                <button type="button" data-modal-target="popup-modal{{ $product->name }}"
        ...
        <script>
            $(document).ready(function() {
                var tabel_inventaris = $('#tb_products').DataTable({
                    // dom: 'Bflrtip',
                    responsive: true,
                    lengthMenu: [
                        [10, 25, 50, -1],
