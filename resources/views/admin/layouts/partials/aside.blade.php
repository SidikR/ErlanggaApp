<aside id="sidebar" class="z-40 hidden h-full w-64 overflow-y-visible transition-transform xl:block"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/webmail"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Emails Page</span>
                </a>
            </li>
        </ul>
    </div>
