<footer class="absolute bottom-0 w-full bg-white dark:bg-gray-900">
    <div class="h-[8%] bg-gray-100 px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between">
